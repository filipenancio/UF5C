...
public class Experimento2 extends SimilarityTestCase {
	...
	// // this.testCluster(0.2f, 0.8f, Metric.JARO_SIMILARITY);
	// this.testCluster(0.3f, 0.7f, Metric.JARO_SIMILARITY);
	// // this.testCluster(0.4f, 0.6f, Metric.JARO_SIMILARITY);
	// }
	//
	// @Test
	// public void testLevenshtein() {
	// // this.testCluster(0.2f, 0.8f, Metric.LEVENSHTEIN_SIMILARITY);
	// this.testCluster(0.3f, 0.7f, Metric.LEVENSHTEIN_SIMILARITY);
	// // this.testCluster(0.4f, 0.6f, Metric.LEVENSHTEIN_SIMILARITY);
	// }

	private void testCluster(float pesoEp, float pesoSl, Metric m) {

		this.testCluster(pesoEp, pesoSl, m, m);
	}
	...
	// File f1 = new File(".\\src\\test\\resource\\teste4\\list-010.xml");
	// File f2 = new File(".\\src\\test\\resource\\teste4\\list-003.xml");
	//
	// // this.simList = new SimList(0.2f, 0.8f, true);
	// // this.testSimilarity(f1, f2, Metric.JARO_SIMILARITY,
	// // Metric.EUCLIDIAN_SIMILARITY);
	// this.testSimilarity(f1, f2, Metric.EUCLIDIAN_SIMILARITY);
	// }
