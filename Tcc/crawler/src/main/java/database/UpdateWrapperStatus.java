...
// Source File Name:   UpdateWrapperStatus.java
...
public class UpdateWrapperStatus
{
    ...
    public static void doit(long id_url, VisitStatus visitlStatus)
    {
        ...
        sqls.add((new StringBuilder("UPDATE tb_url SET id_wrapper_status = ")).append(visitlStatus.getId()).append(" WHERE id = ").append(id_url).toString());
